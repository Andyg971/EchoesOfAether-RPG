...
| **Combat tour par tour** | Solo, **duo** (Kael + Lyra, actes I-II) ou **trio** (Kael + Écho de Lyra + Eran, acte III). Kits complémentaires par personnage (Kael FEU/AETHER · Lyra GLACE/FOUDRE/SOIN · Écho GLACE/SOIN · Eran FOUDRE/AETHER). Faiblesses, boucliers, BREAK (cible cassée = **×1.8 dégâts**), statuts avec **icônes persistantes** (flamme/éclair/bouclier fêlé), **critiques** (12 %, ×1.5), **esquives** (10 %), combo, boss avec enragement. Boost façon Octopath : booster coupe la régénération de BP une manche. **Points de Magie** : réserve qui évolue avec le niveau (L1 = 30, L30 = 146) ; les sorts et le Black Slash coûtent des MP exacts (feu 8 · glace 10 · foudre/soin 12 · aether 14), l'attaque physique est gratuite et en régénère (+6). |
